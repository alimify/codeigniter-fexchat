...
<div class="container root is-fluid" id="fexApp">
    ...
    <div class="fex-app" style="box-shadow: 0px 0px 3px #d4d4d4" id="parent" draggable="true">
        ...
        <div class="f-menu">
            ...
            <header class="f-menu-header">
                ...
                <div class="f mainSetting-parent" style="position: relative;">
                    ...
                    <div class="mainSetting-dropdown">
                        ...
                        <a href="javascript:void(0)" class="dropdown-item" id="mainSettingModal">Messages Settings

                        </a>

                        <a href="javascript:void(0)" class="dropdown-item" id="out-of-office-toggle">Out-of-Office

                        </a>

                        <a href="javascript:void(0)" class="dropdown-item">Help &Tips

                        </a>

                        <a href="javascript:void(0)" class="dropdown-item">Shortcut Keys
            ...
            <main class="f-menu-main">
                ...
                <section id="chatList">
                    ...
                    <div class="f-dropdown">
                        ...
                        <div class="content">
                            ...
                            <a data=0 href="javascript:void(0)" class="dropdown-item active">All

                            </a>

                            <a data=1 href="javascript:void(0)" class="dropdown-item">Unread

                            </a>

                            <a style="display: none;" data=2 href="javascript:void(0)" class="dropdown-item">Contracts Only

                            </a>

                            <a style="display: none;" data=3 href="javascript:void(0)" class="dropdown-item">Interviews Only
                ...
                <section id="searchDisplay">
                    ...
                    <div>
                        <span style="display:none;" uk-spinner="ratio: .8"></span>
                    </div>
        ...
        <div class="f-main">
            ...
            <header class="f-main-header group-chat">
                ...
                <div class="header box" style="padding-left:1rem">
                    ...
                    <article class="media">
                        ...
                        <div class="name-bar" style="align-self:center;display: none;">
                            ...
                            <h4>
                                <!-- Here will display username/job title-->
                            </h4>
                    ...
                    <div style="display: none;" class="view-contract">
                ...
                <div>
                    ...
                    <div class="f-icon add-to-group-parent" style="position: relative;">
                        ...
                        <span class="fa fa-user-plus fa-lg cursor" id="add-to-group-display" style="padding: 0.7em .5em .7em .5em;font-size: initial;"
                            title="Add to Group" uk-tooltip></span>

                        <div class="add-to-group">
                            <div style="width: 90%;margin-left: auto;margin-right: auto;overflow-y: auto;height: 80%">
                            ...
                            <div style="width: 90%;margin-left: auto;margin-right: auto;height: 20%;padding-top: 1rem">
                                ...
                                <div class="field is-grouped is-pulled-right">
                                    ...
                                    <p class="control">
                                        ...
                                        <a class="button is-link" style="background-color: var(--fOrange)">Add
            ...
            <main class="f-main-body" id="mRoot">
                ...
                <div class="uk-align-center spinner-for-msg">
                    <span uk-spinner="ratio: .8"></span>
                </div>
        ...
        <div id="dropZone" dropzone="true">
            <div class="dummy-aside"></div>
            <div id="dropZoneBody">
                <div>
                    <p>Drop Here</p>
                </div>
                ...
                <div class="columns is-flex-desktop-only is-multiline">
                    ...
                    <div class="f-dropdown column is-9">
                        ...
                        <div class="content">
                            ...
                            <a data=1 href="javascript:void(0)" class="dropdown-item">All Activity

                            </a>

                            <a data=2 href="javascript:void(0)" class="dropdown-item">Important Activity only

                            </a>

                            <a data=3 href="javascript:void(0)" class="dropdown-item">Nothing
                    ...
                    <div class="f-dropdown column is-9">
                        ...
                        <div class="content setting-unread-interval">
                            ...
                            <a href="javascript:void(0)" data=1 class="dropdown-item">Immediate

                            </a>

                            <a data=2 href="javascript:void(0)" class="dropdown-item">Every 15 minutes

                            </a>

                            <a data=3 href="javascript:void(0)" class="dropdown-item">Once an hour

                            </a>

                            <a data=4 href="javascript:void(0)" class="dropdown-item">Once a Day

                            </a>

                            <a data=5 href="javascript:void(0)" class="dropdown-item">Only send when offline
                    ...
                    <div class="f-dropdown column is-9">
                        ...
                        <div class="content">
                            ...
                            <a data=1 href="javascript:void(0)" class="dropdown-item">Send Message

                            </a>

                            <a data=2 href="javascript:void(0)" class="dropdown-item">Add a line break
    ...
    <div class="f-modal" id="group-info-modal">
        ...
        <div>
            ...
            <div style="padding: .5rem 0;">
                ...
                <p>
                    <i class="mdi mdi-accounts-outline" style="font-size: 1.35em;vertical-align: text-bottom;"> </i> 5 Participants</p>
            ...
            <div>
                ...
                <div>
                    <p>
                        ...
                        <a href="javascript:void(0)">Exit Group</a>
                    </p>
                </div>
